...
namespace SQLConsoleApp
{
    class Program
    {
        ...
        static readonly string s_akvUrl = "https://{KeyVaultName}.vault.azure.net/keys/CMKAuto1/4a963b7944764597970e997633bb860c";
        static readonly string s_clientId = "";
        static readonly string s_clientSecret = "";
        static readonly string s_connectionString = @"Server=tcp:{ServerName}.database.windows.net,1433; Database=testdb; Column Encryption Setting=Enabled; User ID={Username};Password={Password};";
        // ******************************************
